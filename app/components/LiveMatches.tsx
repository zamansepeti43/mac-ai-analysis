...
export default function LiveMatches() {
  ...
  return <section className="live-section">
    <div className="section-head live-head">
      <div><span className="eyebrow live-eyebrow"><Radio size={13}/> CANLI MAÇLAR</span><h3>🔴 Şu Anda Oynanan Maçlar</h3></div>
      <div className="live-meta"><span>{matches.length} CANLI</span>{updated && <small>15 sn'de yenilenir</small>}</div>
    </div>
    ...
    <div className="live-grid">{matches.map((match) => <article className="live-card" key={match.id}>
